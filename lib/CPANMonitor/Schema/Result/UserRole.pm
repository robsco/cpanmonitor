use utf8;
package CPANMonitor::Schema::Result::UserRole;
...
Related object: L<CPANMonitor::Schema::Result::Role>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WpjIf1R+LtaUjf4hzlgO8w
